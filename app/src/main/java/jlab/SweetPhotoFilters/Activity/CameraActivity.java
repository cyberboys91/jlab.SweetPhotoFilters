...
//TODO: Incomplete
public class CameraActivity extends ImageViewActivity implements SurfaceHolder.Callback {

    protected GPUImageFilterGroup filter;
    private Camera camera;
    private int cameraId;
    private GLSurfaceView svCameraContent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.currentView = findViewById(R.id.gpuImage);
        cameraId = Camera.getNumberOfCameras() > 1 ? 1 : 0;
        this.svCameraContent = ((GPUImageView) currentView).getmGLSurfaceView();
        this.svCameraContent.getHolder().addCallback(this);
        this.svCameraContent.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void loadDataAndGallery(Bundle savedInstanceState) {
        ...
        this.toolbar.setTitle(getString(R.string.camera_folder));
    }
...
//        ivOtherFilter.setOnClickListener(applyFilterAux(FilterType.Other));
    ...
    protected View.OnClickListener undoFilterOnClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            new Thread(new Runnable() {
                @Override
