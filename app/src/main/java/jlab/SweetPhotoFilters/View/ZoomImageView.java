...
//	private static final String DEBUG = "DEBUG";
    ...
    private class DoubleTapZoom implements Runnable {
        ...
        DoubleTapZoom(float targetZoom, float focusX, float focusY, boolean stretchImageToSuper) {
            ...
            //
            startTouch = transformCoordBitmapToTouch(bitmapX, bitmapY, startTouch);
        ...
        private void translateImageToCenterTouchPosition(float t) {
            ...
            PointF curr = transformCoordBitmapToTouch(bitmapX, bitmapY, startTouch);
     ...
     */
    private PointF transformCoordBitmapToTouch(float bx, float by, PointF startTouch) {
        try {
            matrix.getValues(m);
            float origW = getDrawable().getIntrinsicWidth();
            float origH = getDrawable().getIntrinsicHeight();
