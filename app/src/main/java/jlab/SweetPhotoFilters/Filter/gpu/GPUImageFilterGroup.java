...
import jlab.SweetPhotoFilters.Filter.gpu.util.TextureRotationUtil;

import static jlab.SweetPhotoFilters.Filter.gpu.GPUImageRenderer.CUBE;
import static jlab.SweetPhotoFilters.Filter.gpu.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
