...
import static jlab.SweetPhotoFilters.Resource.FileResource.getMimeType;
import static jlab.SweetPhotoFilters.Resource.FileResource.getExtension;
    ...
    public boolean renameTo(String newName) {
        ...
        try {
            ...
            if (!newFile.exists() && file.renameTo(newFile)) {
                ...
                relUrl = relUrl.substring(0, relUrl.length() - name.length()) + newName;
                name = newName;
                return true;
            }
            return false;
