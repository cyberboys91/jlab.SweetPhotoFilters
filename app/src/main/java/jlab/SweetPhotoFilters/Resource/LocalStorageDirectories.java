...
import static jlab.SweetPhotoFilters.Utils.getString;
...
public class LocalStorageDirectories extends LocalDirectory {
    ...
    public ImagesLocalDirectory getImagesDirectory() {
        return (ImagesLocalDirectory) getResource(0);
    }
    ...
    public CameraImagesDirectory getCameraDirectory() {
        return (CameraImagesDirectory) getResource(3);
    }
        ...
        synchronized (monitor) {
            try {
                if (!loaded) {
                    clear();
                    //Special Directories
                    addResource(new ImagesLocalDirectory(getString(R.string.all_images)));
                    ...
                    addResource(new CameraImagesDirectory(getString(R.string.camera_folder)));
